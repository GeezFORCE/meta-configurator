...
import ExportShaclDialog from '@/components/toolbar/dialogs/shaclexport/ExportShaclDialog.vue';
...
<template>
  ...
  <ExportShaclDialog ref="shaclExportDialog" />
  ...
  <TopToolbar
    ...
    @show-export-shacl-dialog="() => showShaclExportDialog()"
